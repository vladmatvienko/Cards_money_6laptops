...
public class GameWindowController {
    ...
    public String[] MASSIVE = new String[6];// Массив карт которые добавляются в игру (Я не уверен, что оно работает, но мне по крайней мере одинаковые карты не попадались)
    ...
    void addCard(ActionEvent event) throws IOException, InterruptedException {
        ...
        int SomeNumber = 0;
        while (SomeNumber==0) {
            String[] nominal = new String[] {"6", "7", "8", "9", "10", "Валет", "Дама", "Король", "Туз"};
